...
-----------------------------------------------------------------
./src/test/java/com.picturerequest/picture/PictureTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/picture-functional-test-config.xml

Defines the Mule configuration for the PictureTestCase.java.
...
artifactId=picture
description=A small example of how to integrate Mule ESB + Activiti
muleVersion=3.1.0
packagePath=com/mycompany/mule
forgeProject=n
transports=ajax,http,vm
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=com.picturerequest
basedir=/Users/estebanroblesluna/Documents/workspaceActivitiGIT
--------------------------------------------------------------------